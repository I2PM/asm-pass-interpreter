package de.athalis.pass.model.TUDarmstadtModel

object Examples {
  private val defaultIPSize = 100

  private val applicant = InternalSubject("Applicant", InternalBehavior(Macro("Main",
    "START",
    Set(
      Action(
        "START",
  ...
  private val supervisor = InternalSubject("Supervisor", InternalBehavior(Macro("Main",
    "START",
    Set(
      Action(
        "START",
  ...
  private val administration = InternalSubject("Administration", InternalBehavior(Macro("Main",
    "START",
    Set(
      Action(
        "START",
  ...
  private val hotelBookingDesk = InternalSubject("HotelBookingDesk", InternalBehavior(Macro("MAIN",
    "START",
    Set(
      Action("START",
        State(function = Some(AutoReceive)),
